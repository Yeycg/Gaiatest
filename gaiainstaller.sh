...
while true; do
    ...
    echo -e "\e[1;85m🔹 Discord: sak_one1\e[0m"
    echo -e "\e[1;85m🔹 X (Twitter): https://x.com/Yey_JCG\e[0m"
...
echo "==============================================================="
    ...
    case $choice in
        1|2|3)
            ...
            rm -rf 1.sh
            curl -O https://github.com/Yeycg/Gaiatest/blob/main/1.sh
            chmod +x 1.sh
            ./1.sh
            ;;
        ...
        4)
            ...
            if [[ "$gaianet_info" == *"Node ID"* || "$gaianet_info" == *"Device ID"* ]]; then
                ...
                curl -O https://raw.githubusercontent.com/Yeycg/Gaiatest/main/gaiachat.sh'"$script_name"' && chmod +x '"$script_name"';
