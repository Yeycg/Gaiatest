...
echo "==============================================================="
    ...
    case $choice in
        1|2|3)
            ...
            rm -rf 1.sh
            curl -O https://raw.githubusercontent.com/Yeycg/Gaiatest/main/1.sh
            chmod +x 1.sh
            ./1.sh
            ;;
        ...
        4)
            ...
            if [[ "$gaianet_info" == *"Node ID"* || "$gaianet_info" == *"Device ID"* ]]; then
                ...
                curl -O https://raw.githubusercontent.com/Yeycg/Gaiatest/main/'"$script_name"' && chmod +x '"$script_name"';
